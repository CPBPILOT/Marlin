...
#define STRING_CONFIG_H_AUTHOR "(Connor Bourque, 4/24/2021, SKR.1.4 TURBO INITIAL STEUP)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Da Vinci Jr 1.C"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2560, 145.5 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 41, 0, -2.5 }

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 28
