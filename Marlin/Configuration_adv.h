...
#define HOMING_BACKOFF_POST_MM { 11.7, 5, 5 }  // (mm) Backoff from endstops after homing
...
//
  ...
  #define DGUS_UPDATE_INTERVAL_MS  200    // (ms) Interval between automatic screen updates
